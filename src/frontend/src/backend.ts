...
export class Backend implements backendInterface {
    ...
    async appendMessage(arg0: string): Promise<Array<Message>> {
        if (this.processError) {
            try {
                const result = await this.actor.appendMessage(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async clearConversation(arg0: Principal | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearConversation(to_candid_opt_n3(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getConversation(arg0: Principal | null): Promise<Array<Message>> {
        if (this.processError) {
            try {
                const result = await this.actor.getConversation(to_candid_opt_n3(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
